...
def MailSender(Filename,time):
    try:
        fromaddr = "akshaychandilkar811@gmail.com"
        ...
        Subject = """
        Marvellous Infosystems Process log generated at : %s"""%(time)  
        ...
        s.login(fromaddr,"jlgm baqb wdox apii")
...
def ProcessLog(log_dir = 'MarvellousInfosystems'):
    listprocess = []
    ...
    #separator = "-" * 80
    #log_path = os.path.join(log_dir,"MarvellousInfosystemsLog%s.log" %(time.ctime()))
    #f = open(log_path,'w')
    #f.write(separator + "\n")
    ...
    log_filename = "MarvellousInfosystemsLog_{}.log".format(timestamp)
...
def main():
    print("----Marvellous Infosystems in Pune----")
    ...
    try:
        ...
        print("Erroe : Invalid data type of input")
